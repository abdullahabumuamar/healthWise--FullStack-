...
export default function TipModal({ isOpen, isEdit, formData, onClose, onSubmit, onInputChange, onImageChange, imagePreview }) {
  ...
  // Set preview when modal opens in edit mode with existing image
  useEffect(() => {
    ...
    <div className={styles.modalOverlay}>
      <div className={styles.modalContent}>
        <div className={styles.modalHeader}>
          <h2 className={styles.modalTitle}>{isEdit ? 'Edit Health Tip' : 'Add New Health Tip'}</h2>
        ...
        <div className={styles.modalBody}>
          ...
          <div className={styles.formGroup}>
            ...
            <input
              ...
              name="subtitle"
              className={styles.formInput}
              placeholder="Enter tip subtitle"
          ...
          <div className={styles.formGroup}>
            <div className={styles.labelWithIcon}>
              <label className={styles.formLabel} htmlFor="content">Full Content</label>
              <div 
